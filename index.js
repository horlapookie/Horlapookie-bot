...
for (const file of commandFiles) {
  try {
    ...
    if (err.message.includes('SyntaxError') || err.message.includes('Unexpected token')) {
      console.log(color(`[ERROR] Syntax error in ${file}: ${err.message}`, 'red'));
      console.log(color(`[INFO] Skipping ${file} due to syntax issues`, 'yellow'));
    } else if (err.message.includes('does not provide an export')) {
      console.log(color(`[ERROR] Import error in ${file}: ${err.message}`, 'red'));
      console.log(color(`[INFO] Skipping ${file} due to import issues`, 'yellow'));
    } else {
